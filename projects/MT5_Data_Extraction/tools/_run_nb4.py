"""Execute NB4 only via nbconvert with extended timeout."""
...
nb_file = "04_RANGE_M5_Strategy_v1.ipynb"
print(f"Executing NB4: {nb_file}")
print("="*60)
...
try:
    ...
    print(f"\nNB4: PASS ({len(nb.cells)} cells executed)")
